                ...
                <tbody>
                    <?php if (!empty($orders)): ?>
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                <td class="text-truncate" style="max-width: 30px;"><?= htmlspecialchars($order['id']) ?></td>
                                <td class="text-truncate" style="max-width: 30px;"><?= htmlspecialchars($order['date']) ?></td>
                                ...
                                <td class="text-truncate" style="max-width: 30px;"><?= htmlspecialchars($order['items']) ?></td>
                                <td>
                                    <span class="badge 
