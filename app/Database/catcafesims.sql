...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2025 at 01:42 PM
...
CREATE TABLE `inventory_adjustments` (
  ...
  `adjustment_type` enum('Restock','Damage','Theft','Other') NOT NULL,
...
--
ALTER TABLE `revenue`
  ADD CONSTRAINT `revenue_ibfk_1` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`sale_id`) ON DELETE CASCADE;
